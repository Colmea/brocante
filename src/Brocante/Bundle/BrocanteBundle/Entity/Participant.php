 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Brocante\Bundle\BrocanteBundle\Entity\ParticipantRepository")
 */
class Participant
{
    /**
    ...
    /**
    * @ORM\OneToOne(targetEntity="Reservation", mappedBy="participant", cascade={"persist"})
    */
    private $reservation;
